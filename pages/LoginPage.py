...
class LoginPage(BasePage):
    ...
    BTN_LOGIN = (By.XPATH, "/html/body/div[1]/div[1]/div/div[1]/div/div[2]/div[2]/form/div[3]/button")
    MSG_INVALIDCREDS = (By.CLASS_NAME,"oxd-text oxd-text--p oxd-alert-content-text")

    """Constructor of CarreersPage class"""
